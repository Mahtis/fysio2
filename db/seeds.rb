...
layers = Layer.create([{ name: 'Application' },
                       { name: 'Logic' },
                       { name: 'Indicies' },
                       { name: 'Metrics' },
                       { name: 'Signal' },
                       { name: 'Software' },
                       { name: 'Hardware' }])
layerTypes = LayerType.create([{ name: 'Science',
                                 layers: Layer.where(id: [1, 2, 3, 4, 5]) },
                               { name: 'Hacker',
                                 layers: Layer.where(id: [6, 7]) }])
publications = Publication.create([{ name: 'Audio Biofeedback for Poker Players',
...
publications[0].links.create(url: 'www.nature.com',
                             publication_id: 1,
                             link_type: 'web')
publications[1].links.create(url: 'www.science.com',
                             publication_id: 2,
                             link_type: 'web')
publications[1].links.create(url: 'www.github.com',
                             publication_id: 2,
                             link_type: 'github')
publications[2].links.create(url: 'www.suomi24.fi',
                             publication_id: 3,
                             link_type: 'web')
publications[3].links.create(url: 'cs.helsinki.fi',
                             publication_id: 4,
                             link_type: 'web')
publications[4].links.create(url: 'www.science.com',
                             publication_id: 5,
                             link_type: 'web')
publications[5].links.create(url: 'www.nature.com',
                             publication_id: 6,
                             link_type: 'web')

Author.create(name: 'Pasi Kosunen',
              publications: Publication.where(id: [1, 2, 3]))
Author.create(name: 'Ilkka Kosunen',
              publications: Publication.where(id: [1, 2, 5, 6]))
Author.create(name: 'Seppo Ilmarinen',
              publications: Publication.where(id: [4, 3, 6]))
